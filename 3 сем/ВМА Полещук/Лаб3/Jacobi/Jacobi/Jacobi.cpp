...
int main()
{
	...
	// Найдем относительную погрешность через кубическую норму по формуле ||Х - Х*||/||Х||
	...
	cout << "Теоретическая оценка числа итераций: " << theoreticalNumberOfIterations << endl;
	if (theoreticalNumberOfIterations > currk)
	{
		cout << "Теоретическая оценка числа итераций для достижения точности больше числа потребовавшихся итераций метода " << endl;
	}
	else if (theoreticalNumberOfIterations < currk)
	{
		cout << "Теоретическая оценка числа итераций для достижения точности меньше числа потребовавшихся итераций метода " << endl;
	}
	else
	{
		cout << "Теоретическая оценка числа итераций для достижения точности равна числу потребовавшихся итераций метода " << endl;
	}
